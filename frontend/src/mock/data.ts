...
export const mockQuestions = [
  ...
  { id: 53, questionCode: 'VALUE_04', dimension: 'PSYCHOLOGY', questionText: '当你正准备进行一场手术时，发现躺在手术台上的是曾经霸凌你的人，你是否还会救？', questionType: 'VALUE_JUDGE', optionsJson: '[{"label":"A","value":"1","text":"救"},{"label":"B","value":"2","text":"不救"}]', sortOrder: 53, isRequired: 1, isAttentionCheck: 0, status: 1 },
